...
| <a name="input_nsg-1-rule-2"></a> [nsg-1-rule-2](#input\_nsg-1-rule-2) | NSG rule (Allow Inbound SSH and RDP) for internal load balancer subnet | `map` | <pre>{<br/>  "access": "Allow",<br/>  "destination_address_prefix": "10.0.1.0/24",<br/>  "destination_port_range": 3389,<br/>  "direction": "Inbound",<br/>  "name": "allowInbound-SSH-RDP",<br/>  "priority": 400,<br/>  "protocol": "*",<br/>  "source_address_prefix": "VirtualNetwork",<br/>  "source_port_range": "*"<br/>}</pre> |
