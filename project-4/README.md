...
| <a name="input_nsg-1-rule-1"></a> [nsg-1-rule-1](#input\_nsg-1-rule-1) | NSG rule (Allow Inbound HTTP/HTTPS) for internal load balancer subnet | <pre>map(object({<br/>    name                       = string<br/>    priority                   = any<br/>    direction                  = string<br/>    access                     = string<br/>    protocol                   = string<br/>    source_port_range          = string<br/>    destination_port_range     = any<br/>    source_address_prefix      = string<br/>    destination_address_prefix = string<br/>  }))</pre> | <pre>{<br/>  "first": {<br/>    "access": "Allow",<br/>    "destination_address_prefix": "10.0.1.0/24",<br/>    "destination_port_range": 80,<br/>    "direction": "Inbound",<br/>    "name": "allowInbound-HTTP",<br/>    "priority": 200,<br/>    "protocol": "*",<br/>    "source_address_prefix": "VirtualNetwork",<br/>    "source_port_range": "*"<br/>  },<br/>  "second": {<br/>    "access": "Allow",<br/>    "destination_address_prefix": "10.0.1.0/24",<br/>    "destination_port_range": 443,<br/>    "direction": "Inbound",<br/>    "name": "allowInbound-HTTP",<br/>    "priority": 210,<br/>    "protocol": "*",<br/>    "source_address_prefix": "VirtualNetwork",<br/>    "source_port_range": "*"<br/>  }<br/>}</pre> |
...
| <a name="input_nsg-2-rule-1"></a> [nsg-2-rule-1](#input\_nsg-2-rule-1) | NSG rule (Allow Inbound HTTP/HTTPS) for external load balancer subnet | <pre>map(object({<br/>    name                       = string<br/>    priority                   = any<br/>    direction                  = string<br/>    access                     = string<br/>    protocol                   = string<br/>    source_port_range          = string<br/>    destination_port_range     = any<br/>    source_address_prefix      = string<br/>    destination_address_prefix = string<br/>  }))</pre> | <pre>{<br/>  "first": {<br/>    "access": "Allow",<br/>    "destination_address_prefix": "10.0.2.0/24",<br/>    "destination_port_range": 80,<br/>    "direction": "Inbound",<br/>    "name": "allowInbound-HTTP",<br/>    "priority": 220,<br/>    "protocol": "*",<br/>    "source_address_prefix": "VirtualNetwork",<br/>    "source_port_range": "*"<br/>  },<br/>  "second": {<br/>    "access": "Allow",<br/>    "destination_address_prefix": "10.0.2.0/24",<br/>    "destination_port_range": 443,<br/>    "direction": "Inbound",<br/>    "name": "allowInbound-HTTP",<br/>    "priority": 230,<br/>    "protocol": "*",<br/>    "source_address_prefix": "VirtualNetwork",<br/>    "source_port_range": "*"<br/>  }<br/>}</pre> |
