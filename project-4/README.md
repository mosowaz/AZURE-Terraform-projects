...
| [azurerm_virtual_machine_scale_set_extension.linux_nginx_install](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/virtual_machine_scale_set_extension) | resource |
| [azurerm_virtual_machine_scale_set_extension.windows_iis_install](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/virtual_machine_scale_set_extension) | resource |
...
| <a name="input_nsg-1-rules"></a> [nsg-1-rules](#input\_nsg-1-rules) | NSG rule (Allow Inbound HTTP/RDP) for internal load balancer subnet | <pre>map(object({<br/>    name                       = string<br/>    priority                   = any<br/>    direction                  = string<br/>    access                     = string<br/>    protocol                   = string<br/>    source_port_range          = string<br/>    destination_port_range     = any<br/>    source_address_prefix      = string<br/>    destination_address_prefix = string<br/>  }))</pre> | <pre>{<br/>  "first": {<br/>    "access": "Allow",<br/>    "destination_address_prefix": "*",<br/>    "destination_port_range": 80,<br/>    "direction": "Inbound",<br/>    "name": "allowInbound-HTTP-int",<br/>    "priority": 200,<br/>    "protocol": "*",<br/>    "source_address_prefix": "*",<br/>    "source_port_range": "*"<br/>  },<br/>  "second": {<br/>    "access": "Allow",<br/>    "destination_address_prefix": "*",<br/>    "destination_port_range": 3389,<br/>    "direction": "Inbound",<br/>    "name": "allowInbound-RDP-int",<br/>    "priority": 210,<br/>    "protocol": "*",<br/>    "source_address_prefix": "VirtualNetwork",<br/>    "source_port_range": "*"<br/>  }<br/>}</pre> |
| <a name="input_nsg-2-rules"></a> [nsg-2-rules](#input\_nsg-2-rules) | NSG rule (Allow Inbound HTTP/SSH) for external load balancer subnet | <pre>map(object({<br/>    name                       = string<br/>    priority                   = any<br/>    direction                  = string<br/>    access                     = string<br/>    protocol                   = string<br/>    source_port_range          = string<br/>    destination_port_range     = any<br/>    source_address_prefix      = string<br/>    destination_address_prefix = string<br/>  }))</pre> | <pre>{<br/>  "first": {<br/>    "access": "Allow",<br/>    "destination_address_prefix": "*",<br/>    "destination_port_range": 80,<br/>    "direction": "Inbound",<br/>    "name": "allowInbound-HTTP-ext",<br/>    "priority": 220,<br/>    "protocol": "*",<br/>    "source_address_prefix": "*",<br/>    "source_port_range": "*"<br/>  },<br/>  "second": {<br/>    "access": "Allow",<br/>    "destination_address_prefix": "*",<br/>    "destination_port_range": 22,<br/>    "direction": "Inbound",<br/>    "name": "allowInbound-RDP-ext",<br/>    "priority": 230,<br/>    "protocol": "*",<br/>    "source_address_prefix": "VirtualNetwork",<br/>    "source_port_range": "*"<br/>  }<br/>}</pre> |
